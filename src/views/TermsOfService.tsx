...
export default function TermsOfService() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-6 pt-4 lg:pt-6 pb-24">
      <button
        onClick={() => router.push('/')}
        className="text-xs font-semibold text-text-muted uppercase tracking-widest mb-10 flex items-center gap-2 hover:text-secondary transition-colors"
      >
        ← Back to Home
      </button>

      <div className="mb-10 border-b border-outline pb-8">
        <span className="inline-block px-3 py-1 bg-surface-dim border border-outline text-[10px] font-bold tracking-widest uppercase text-text-muted rounded-sm mb-4">
          Legal
        </span>
      ...
      <div className="space-y-10 text-text-muted leading-relaxed">
        ...
        <section>
          ...
          <p className="text-sm">
            While we strive to keep information accurate and up to date, Durozen
            makes no warranties regarding completeness or accuracy.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-sm">
            ...
            the property of Durozen unless otherwise stated.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-sm">
            Durozen shall not be liable for any direct or indirect damages
