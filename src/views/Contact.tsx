...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      if (!SCRIPT_URL) {
        throw new Error(
          'API URL is not configured in the environment variables.',
        );
      }
        ...
        <div className="max-w-7xl mx-auto px-6 pt-4 lg:pt-6 pb-8">
          <div className="text-center max-w-3xl mx-auto mb-12 lg:mb-16">
            ...
            <h2 className="text-2xl font-semibold text-primary mb-4">
              Start your enterprise technology conversation.
            </h2>
            <p className="text-lg text-text-muted">
              Tell us what you want to build, modernize, or automate. Our team
                ...
                {submitStatus === 'success' ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-text-muted mb-6">
                      Thank you for submitting your inquiry. We&apos;ll be in
                  ...
                  <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <button
                      type="submit"
                      disabled={isSubmitting}
                      className="w-full bg-secondary text-white py-4 rounded-lg font-bold hover:bg-red-700 transition-colors flex items-center justify-center disabled:opacity-70"
                    >
                      {isSubmitting ? (
                        <>
              ...
              <div className="bg-surface border border-outline p-8 rounded-xl shadow-sm mt-8 text-center">
                ...
                <div className="flex justify-center space-x-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-3 bg-blue-50 text-blue-600 rounded-full hover:bg-blue-600 hover:text-white transition-colors flex items-center justify-center"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-3 bg-pink-50 text-pink-600 rounded-full hover:bg-pink-600 hover:text-white transition-colors flex items-center justify-center"
                  >
