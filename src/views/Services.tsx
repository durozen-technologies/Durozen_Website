        ...
        <div className="max-w-7xl mx-auto px-6 pt-4 lg:pt-6 pb-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-text-muted">
              Premium delivery across software, cloud, AI, product design, data,
              ...
              return (
                ...
                >
                  <div className="mb-6 p-4 bg-primary/5 w-16 h-16 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                    <div
                      className={`text-slate-400 transition-colors ${activeColorClass.split(' ')[0]}`}
                    >
                      {service.icon}
                    </div>
                  </div>
                  ...
                  <p className="text-text-muted flex-grow mb-6">
                    {service.description}
                  </p>
                  <Link
                    href="/contact"
