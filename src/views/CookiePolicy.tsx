    ...
    <div className="w-full max-w-4xl mx-auto px-6 pt-4 lg:pt-6 pb-24">
      ...
      <div className="space-y-10 text-text-muted leading-relaxed">
        <p className="text-base text-text-main">
          This website uses cookies to improve user experience and website
          performance.
        </p>
        ...
        <section>
          ...
          <p className="text-sm">
            Our website may use services such as Google Analytics, which may
            place cookies on your device to help us understand website usage.
          </p>
        </section>
