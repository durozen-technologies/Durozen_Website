  ...
  const benefits = [
    {
      ...
      description:
        'Build serious enterprise products that solve complex operational problems at scale.',
      icon: <Terminal className="w-6 h-6 text-blue-500 mb-4" />,
    },
    {
      title: 'Strong Culture',
      description:
        'Work with a team of ambitious, driven engineers who value execution over politics.',
      icon: <Users className="w-6 h-6 text-blue-500 mb-4" />,
    },
    {
      title: 'Fast Growth',
      description:
        'Take on massive responsibilities early. We reward velocity and high-quality output.',
        ...
        <section className="py-8 bg-primary text-white">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <p className="text-xl text-blue-100 max-w-2xl mx-auto leading-relaxed">
              We&apos;re always looking for sharp, dedicated people to join our
          ...
          <div className="mb-24 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {benefits.map((benefit, idx) => (
                <div
                  key={idx}
                  className="bg-surface p-8 rounded-xl border border-outline shadow-sm text-left"
                >
                  {benefit.icon}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-surface p-8 rounded-lg border border-outline text-center mb-16 shadow-sm">
              ...
              <p className="text-text-muted">
                We currently don&apos;t have any specific roles open. However,
            ...
            <div className="bg-surface p-8 rounded-xl border border-outline shadow-sm">
              <div className="text-center mb-8">
                ...
                <p className="text-text-muted">
                  We are always open to meeting talented engineers, designers,
                  and operators. Send us your details.
                </p>
              </div>
              ...
              {submitStatus === 'success' ? (
                <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center animate-fade-in">
                  ...
                  <p className="text-green-700">
                    Thank you for your interest in Durozen. Our team will review
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-background border border-outline rounded-lg focus:ring-2 focus:ring-secondary focus:border-secondary transition-colors disabled:opacity-50"
                        placeholder="Name"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      disabled={isSubmitting}
                      className="w-full px-4 py-3 bg-background border border-outline rounded-lg focus:ring-2 focus:ring-secondary focus:border-secondary transition-colors disabled:opacity-50 resize-y"
