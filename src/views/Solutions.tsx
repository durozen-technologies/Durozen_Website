        ...
        <div className="max-w-7xl mx-auto px-6 pt-4 lg:pt-6 pb-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-text-muted">
              Business platforms that solve operational problems. We design
              systems around business outcomes: faster decisions, cleaner
              operations, better customer experiences, and scalable digital
              revenue.
            </p>
          </div>
