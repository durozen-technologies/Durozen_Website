      ...
      <div className="prose max-w-none space-y-10 text-text-muted leading-relaxed">
        ...
        <section>
          ...
          <p className="text-sm">
            ...
            parties. Information may only be shared where required by law.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-sm">
            ...
            respond to enquiries and fulfil legitimate business purposes.
          </p>
        </section>
        ...
        <section className="bg-surface border border-outline rounded-lg p-6">
          ...
          <p className="text-sm text-text-muted">
            If you have any concerns about how your information is handled, you
