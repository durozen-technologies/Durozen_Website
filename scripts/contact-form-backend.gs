        ...
        <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background-color: #f5f5f5; padding: 20px; border-radius: 5px; margin: 25px 0;">
            ...
            <ul style="margin: 15px 0; padding-left: 0; list-style: none;">
              <li style="margin: 10px 0; color: #555;">📧 <a href="mailto:info@durozen.in" style="color: #667eea; text-decoration: none;">info@durozen.in</a></li>
              <li style="margin: 10px 0; color: #555;">📞 <a href="tel:+918122339694" style="color: #667eea; text-decoration: none;">+91 81223 39694</a></li>
            </ul>
          </div>
