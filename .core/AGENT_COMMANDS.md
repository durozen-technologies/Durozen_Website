...
- **`/spec`**
  - **Action**: Stops immediate coding. Forces the agent to ask questions, do research, and write a full Product Requirements Document (PRD) to clarify exactly _what_ to build and _why_.
- **`/plan`**
...
- **`/review`**
  - **Action**: Runs a strict multi-axis code review on the codebase. The agent reviews the code for health, architecture, security, and edge cases _before_ merging.
- **`/webperf`**
